...
public class CardDAOTest {
    ...
    public static void setUpClass() {
            ...
            card.setEmail("Test");
            card.setStatus(true);
            CardsDAO cardsave = new CardsDAOImpl();
            iduser  = cardsave.save(card);
    }
    
    @AfterClass
    public static void tearDownClass() {
        Card card = new CardsDAOImpl().getById(iduser);
           new CardsDAOImpl().remove(card);
           Card card1 = new CardsDAOImpl().getById(iduser1);
           new CardsDAOImpl().remove(card1);
    }
    ...
    public void testSave() {
            ...
            card.setEmail("Test1");
            card.setStatus(true);
            CardsDAOImpl cardsave = new CardsDAOImpl();
    ...
    public void testUpdate() {
            ...
            new CardsDAOImpl().update(card);
            Card card1 = new CardsDAOImpl().getById(iduser);
        Assert.assertNotNull("entity not found", card1);
...
//    }
    ...
    public void testGetList() {
         List<Card> card = new CardsDAOImpl().getList();
        Assert.assertNotNull("entity not found", card);
    }
    ...
    public void testChangeStatus() {
        new CardsDAOImpl().changeStatus(iduser);
        Card card = new CardsDAOImpl().getById(iduser);
        Assert.assertNotNull("entity not found", card);
